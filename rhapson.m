function [output] = rhapson(Ri, Ro, lambda, Pi)
...
for index1 = 0:n-1 
    ...
    sigma_extra1 = Constitutive_model(F1); % calculate sigma_extra using the constitutive model
    ...
    sigma_extra2 = Constitutive_model(F2); % calculate sigma_extra using the constitutive model
