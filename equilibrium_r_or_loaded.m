function [output_r_or] = equilibrium_r_or_loaded(Ri, Ro, lambda, Pi, materialParameters, x0)
...
for index1 = 0:n-1 % for loop going from inner to outer radius
    ...
    F2 = diag([R2/(lambda*r2) r2/R2 lambda]); % define the the deformation gradient tensor (use the diag function)
